...
class ConfigController extends AppController
{
    ...
    public function dhcp()
    {
        ...
        $dhcp_enabled_input = $this->Config->get('dhcp_enabled_input');
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            */
            ...
            $data_dhcp_enabled_input = $this->Config->patchEntity($dhcp_enabled_input, $confdata);
            if($data_dhcp_enabled_input->errors()) {
                $rc = 1;
            }

            $confdata = array(
                'param' => 'dhcp_enabled_output',
                'value' => $this->request->data['dhcp_enabled_output']
                );
            $data_dhcp_enabled_output = $this->Config->patchEntity($dhcp_enabled_output, $confdata);
            if($data_dhcp_enabled_output->errors()) {
                $rc = 1;
            }
            ...
            */
            ...
            if ($rc == 0)
            {
                ...
                $this->Config->save($data_dhcp_enabled_input);
